...
abstract class JModuleHelper {
    ...
    public static function renderModule($module, $attribs = array()) {
        ...
        include_once ZO2PATH_ROOT . '/html/site/modules.php';
    ...
    public static function getLayoutPath($module, $layout = 'default') {
        ...
        $zo2Path = ZO2PATH_ROOT . '/html/sites/' . $module . '/' . $layout . '.php';
    ...
    public static function moduleCache($module, $moduleparams, $cacheparams) {
        ...
        switch ($cacheparams->cachemode) {
            case 'id':
                $ret = $cache->get(
                        array($cacheparams->class, $cacheparams->method), $cacheparams->methodparams, $cacheparams->modeparams, $wrkarounds, $wrkaroundoptions
                );
                break;
            ...
            case 'safeuri':
                ...
                $ret = $cache->get(
                        array($cacheparams->class, $cacheparams->method), $cacheparams->methodparams, $module->id . $view_levels . $secureid, $wrkarounds, $wrkaroundoptions
                );
                break;
            ...
            case 'static':
                $ret = $cache->get(
                    ...
                    $cacheparams->method), $cacheparams->methodparams, $module->module . md5(serialize($cacheparams->methodparams)), $wrkarounds, $wrkaroundoptions
                );
                break;
            ...
            case 'oldstatic':
                $ret = $cache->get(
                        array($cacheparams->class, $cacheparams->method), $cacheparams->methodparams, $module->id . $view_levels, $wrkarounds, $wrkaroundoptions
                );
                break;
            ...
            default:
                $ret = $cache->get(
                        array($cacheparams->class, $cacheparams->method), $cacheparams->methodparams, $module->id . $view_levels . JFactory::getApplication()->input->getInt('Itemid', null), $wrkarounds, $wrkaroundoptions
                );
                break;
        }
