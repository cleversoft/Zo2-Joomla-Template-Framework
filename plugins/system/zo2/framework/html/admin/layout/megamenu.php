...
<link type="text/css" rel="stylesheet" href="<?php echo ZO2URL_MEGAMENU; ?>/admin/plugins/chosen/chosen.css" />
<link type="text/css" rel="stylesheet" href="<?php echo ZO2URL_MEGAMENU; ?>/base/css/megamenu.css" />
<link type="text/css" rel="stylesheet" href="<?php echo ZO2URL_MEGAMENU; ?>/admin/megamenu/css/megamenu.css" />
<link type="text/css" rel="stylesheet" href="<?php echo ZO2URL_MEGAMENU; ?>/admin/css/admin.css" />

<link type="text/css" rel="stylesheet" href="<?php echo ZO2URL_MEGAMENU; ?>/admin/fonts/glyphicon/css/glyphicon.css" />

<script type="text/javascript" src="<?php echo ZO2URL_MEGAMENU; ?>/admin/js/json2.js"></script>
<script type="text/javascript" src="<?php echo ZO2URL_MEGAMENU; ?>/admin/plugins/chosen/chosen.jquery.min.js"></script>
<script type="text/javascript" src="<?php echo ZO2URL_MEGAMENU; ?>/includes/depend/js/depend.js"></script>
<script type="text/javascript" src="<?php echo ZO2URL_MEGAMENU; ?>/admin/megamenu/js/megamenu.js"></script>
        ...
        <div class="controls-row">
            <div class="control-group t3-control-group">
                <div class="control-label t3-control-label">
                    <label id="menu-type-lbl" for="menu-type" class="hasTip" data-placement="right" title="<?php echo JText::_('T3_NAVIGATION_MM_TYPE_LABEL', 'T3_NAVIGATION_MM_TYPE_DESC') ?>"><?php echo JText::_('T3_NAVIGATION_MM_TYPE_LABEL'); ?></label>
                </div>
            ...
            <div class="control-group t3-control-group">
                <div class="control-label t3-control-label">
                    <label id="access-level-lbl" for="access-level" class="hasTip" title="<?php echo JText::_('T3_NAVIGATION_ACL_LABEL', 'T3_NAVIGATION_ACL_DESC') ?>"><?php echo JText::_('T3_NAVIGATION_ACL_LABEL'); ?></label>
                </div>
                <div class="controls t3-controls">
            ...
            <div class="t3-admin-mm-row clearfix">
                ...
                <div id="t3-admin-mm-tb">
                    <div id="t3-admin-mm-toolitem" class="admin-toolbox">
                        ...
                        <ul>
                            <li>
                                <label class="hasTip" title="<?php echo JText::_('T3_NAVIGATION_MM_SUBMENU', 'T3_NAVIGATION_MM_SUBMENU_DESC') ?>"><?php echo JText::_('T3_NAVIGATION_MM_SUBMENU') ?></label>
                        ...
                        <ul>
                            <li>
                                <label class="hasTip" title="<?php echo JText::_('T3_NAVIGATION_MM_GROUP', 'T3_NAVIGATION_MM_GROUP_DESC') ?>"><?php echo JText::_('T3_NAVIGATION_MM_GROUP') ?></label>
                        ...
                        <ul>
                            <li>
                                <label class="hasTip" title="<?php echo JText::_('T3_NAVIGATION_MM_POSITIONS', 'T3_NAVIGATION_MM_POSITIONS_DESC') ?>"><?php echo JText::_('T3_NAVIGATION_MM_POSITIONS') ?></label>
                        ...
                        <ul>
                            <li>
                                <label class="hasTip" title="<?php echo JText::_('T3_NAVIGATION_MM_EX_CLASS', 'T3_NAVIGATION_MM_EX_CLASS_DESC') ?>"><?php echo JText::_('T3_NAVIGATION_MM_EX_CLASS') ?></label>
                                <fieldset class="">
                        ...
                        <ul>
                            <li>
                                <label class="hasTip" data-placement="right" title="<?php echo JText::_('T3_NAVIGATION_MM_ICON', 'T3_NAVIGATION_MM_ICON_DESC') ?>">
                        ...
                        <ul>
                            <li>
                                <label class="hasTip" title="<?php echo JText::_('T3_NAVIGATION_MM_CAPTION', 'T3_NAVIGATION_MM_CAPTION_DESC') ?>">
                    ...
                    <div id="t3-admin-mm-toolsub" class="admin-toolbox">
                        ...
                        <ul>
                            <li>
                                <label class="hasTip" title="<?php echo JText::_('T3_NAVIGATION_MM_SUBMNEU_GRID', 'T3_NAVIGATION_MM_SUBMNEU_GRID_DESC') ?>"><?php echo JText::_('T3_NAVIGATION_MM_SUBMNEU_GRID') ?></label>
                                <fieldset class="btn-group">
                        ...
                        <ul>
                            <li>
                                <label class="hasTip" title="<?php echo JText::_('T3_NAVIGATION_MM_HIDE_COLLAPSE', 'T3_NAVIGATION_MM_HIDE_COLLAPSE_DESC') ?>"><?php echo JText::_('T3_NAVIGATION_MM_HIDE_COLLAPSE') ?></label>
                        ...
                        <ul>
                            <li>
                                <label class="hasTip" title="<?php echo JText::_('T3_NAVIGATION_MM_SUBMNEU_WIDTH_PX', 'T3_NAVIGATION_MM_SUBMNEU_WIDTH_PX_DESC') ?>"><?php echo JText::_('T3_NAVIGATION_MM_SUBMNEU_WIDTH_PX') ?></label>
                                <fieldset class="">
                        ...
                        <ul>
                            <li>
                                <label class="hasTip" title="<?php echo JText::_('T3_NAVIGATION_MM_ALIGN', 'T3_NAVIGATION_MM_ALIGN_DESC') ?>"><?php echo JText::_('T3_NAVIGATION_MM_ALIGN') ?></label>
                    ...
                    <div id="t3-admin-mm-toolcol" class="admin-toolbox">
                        ...
                        <ul>
                            <li>
                                <label class="hasTip" title="<?php echo JText::_('T3_NAVIGATION_MM_ADD_REMOVE_COLUMN', 'T3_NAVIGATION_MM_ADD_REMOVE_COLUMN_DESC') ?>"><?php echo JText::_('T3_NAVIGATION_MM_ADD_REMOVE_COLUMN') ?></label>
                                <fieldset class="btn-group">
                        ...
                        <ul>
                            <li>
                                <label class="hasTip" title="<?php echo JText::_('T3_NAVIGATION_MM_WIDTH_SPAN', 'T3_NAVIGATION_MM_WIDTH_SPAN_DESC') ?>"><?php echo JText::_('T3_NAVIGATION_MM_WIDTH_SPAN') ?></label>
                                <fieldset class="">
                        ...
                        <ul>
                            <li>
                                <label class="hasTip" title="<?php echo JText::_('T3_NAVIGATION_MM_MODULE', 'T3_NAVIGATION_MM_MODULE_DESC') ?>"><?php echo JText::_('T3_NAVIGATION_MM_MODULE') ?></label>
                                <fieldset class="">
                        ...
                        <ul>
                            <li>
                                <label class="hasTip" title="<strong><?php echo JText::_('T3_NAVIGATION_MM_EX_CLASS', 'T3_NAVIGATION_MM_EX_CLASS_DESC') ?>"><?php echo JText::_('T3_NAVIGATION_MM_EX_CLASS') ?></label>
                                <fieldset class="">
