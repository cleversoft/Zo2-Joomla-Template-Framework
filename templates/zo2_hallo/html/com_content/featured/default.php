...
$pagesTotal = isset($this->pagination->pagesTotal) ? $this->pagination->pagesTotal : $this->pagination->total;
...
<div class="blog-featured<?php echo $this->pageclass_sfx; ?>">
    ...
    <?php endif; ?>
    <?php if ($this->params->def('show_pagination', 2) == 1 || ($this->params->get('show_pagination') == 2 && $this->pagination->get('page.total') > 1)) : ?>
