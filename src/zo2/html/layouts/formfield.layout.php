                ...
                <div class="zo2-tabs-content">
                    ...
                    <div id="row-responsive">
                        ...
                        <div class="control-group">
                            ...
                            <div class="control-label">
                                <div class="control-label"><?php JText::_('ZO2_ADMIN_FORMFIELD_LAYOUT_DESKTOP'); ?></div>
                            </div>
                ...
                <div class="zo2-tabs-content">
                    ...
                    <div id="column-responsive">
                        <div class="control-group">
                            ...
                            -->
                            <div class="control-label">
                                <div class="control-label"><?php JText::_('ZO2_ADMIN_FORMFIELD_LAYOUT_PHONE'); ?></div>
                            </div>
                        ...
                        <div class="control-group">
                            ...
                            -->
                            <div class="control-label">
                                <div class="control-label"><?php JText::_('ZO2_ADMIN_FORMFIELD_LAYOUT_TABLET'); ?></div>
                            </div>
                        ...
                        <div class="control-group">
                            ...
                            -->
                            <div class="control-label">
                                <div class="control-label"><?php JText::_('ZO2_ADMIN_FORMFIELD_LAYOUT_LARGE_DESKTOP'); ?></div>
                            </div>
