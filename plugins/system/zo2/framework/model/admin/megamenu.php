...
if (!class_exists('Zo2ModelAdminMegamenu'))
{
    Zo2Framework::importVendor('t3');

    class Zo2ModelAdminMegamenu
    {
        ...
        public function render($params = array())
        {
            ...
            return $buffer . '<input id="megamenu-key" type="hidden" name="mmkey" value="' . $mmkey . '"/>';
        }
         ...
         */
        public function megamenu($configs = array())
        {
            $tplparams = $configs;
            ...
            $html = new Zo2Html();
            $html->set('menus', $this->menus());
            $html->set('access', $this->access());
            $html->set('modules', $this->modules());
            $html->set('mm_type', $mm_type);
            return $html->fetch('Zo2://html/admin/layout/megamenu.php');
        }
