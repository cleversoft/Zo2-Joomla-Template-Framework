            ...
            <div class="row-fluid">
                <div class="span12">
                    ...
                    <ul class="task-list">
						...
						<li>Fixing <a href="https://github.com/cleversoft/zo2/issues">issues</a></li>
						<li>Replying to questions on <a href="http://www.zootemplate.com/zo2-support">the forum</a></li>
					</ul>
                    ...
                    <div class="zo2-divider"></div>
                    <h3>Supports</h3>
                    <p>Use the <a href="http://www.zootemplate.com/zo2-support">Zo2 Support</a> to ask questions and get support.</p>
                    <div class="zo2-divider"></div>
                    <h2>Copyright, License &amp; Usage</h2>
                   	<p>Copyright (c) 2008 - 2014 <a href="http://cleversoft.co">CleverSoft Solutions</a></p>
                    <h3>License</h3>
                    <p>Zo2Framework is licensed under GNU General Public License (GPL), version 2 or later. <br /> <a href="http://www.gnu.org/licenses/gpl-2.0.html">http://www.gnu.org/licenses/gpl-2.0.html</a></p>
                    <h3>Usage</h3>
                    ...
                    <h3>Credits</h3>
                    <ul class="task-list">
						<li><a href="http://fortawesome.github.io/Font-Awesome/icons/">FontAwesome Icons</a>)</li>
