...
class JFormFieldMegaMenu extends JFormFieldHidden
{
    ...
    protected function getContent()
    {
        ...
        if (!defined ('ZO_MEGAMENU_ASSET')) {
            ...
            $jdoc->addStylesheet(ZO2RTP_ASSETS_ZO2 . '/css/megamenu.css');
            $jdoc->addStyleSheet(ZO2RTP_ASSETS_ZO2 . '/css/adminmegamenu.css');
            $jdoc->addScript(ZO2RTP_ASSETS_ZO2 . '/js/adminmegamenu.min.js');
